                ...
                <div className="relative w-[50%] max-md:w-[90%] mx-auto">
                    <div>
                        <p className="text-lg max-md:text-base block pt-4 max-md:pt-0 text-[#fff]">
                            人気ラジオパーソナリティ、DJ浅い人間が盟友リリック・ハメ太郎,妖精ポテトジャンキーと共に毎週土曜24時から池袋FMより放送するラジオ番組「カゲゴノミ」。<br />
                            ファミレスの雑談よりどうでもいいトークを、日々のストレスと鬱屈とした人生の怒りにまかせて喋り散らかす激動の30分！<br />
                            2035年に開催確定している日比谷野外大音楽堂での主催トークイベントをソールドアウトさせるため、日々邁進中。
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="md:hidden block w-full">
                        ...
                        <div>
                            ...
                            <p className="text-sm block pt-3">
                                限界サラリーマン兼ラジオパーソナリティ。<br />
                                2022年にYouTubeでオリジナルラジオ番組「独身の被害妄想」をスタート。<br />
                                3か月後、人生初の彼女ができた際に番組名を現在の「カゲゴノミ」に変更。<br />
                                その2か月後、童貞のまま彼女と別れる。<br />
                                2023年に池袋FMで放送を開始し、毎年カゲゴノミ主催の公開収録やミクスチャーイベントも開催している。
                            </p>
                        </div>
                    </div>
